...
Game.init = function()
    ...
    table.insert(enemy.array, enemy.new(490, -1130, Turtle.scrollingSpeed, HOLE)) 
    ...
    table.insert(enemy.array, enemy.new(350, -1612, Turtle.scrollingSpeed, HOLE)) 
    ...
    table.insert(enemy.array, enemy.new(371, -2180, Turtle.scrollingSpeed, HOLE)) 
    table.insert(enemy.array, enemy.new(488, -2236, Turtle.scrollingSpeed, HOLE)) 
    table.insert(enemy.array, enemy.new(188, -2311, Turtle.scrollingSpeed, HOLE)) 
    ...
    table.insert(enemy.array, enemy.new(478, -3506, Turtle.scrollingSpeed, HOLE))
    table.insert(enemy.array, enemy.new(192, -3787, Turtle.scrollingSpeed, HOLE))
    table.insert(enemy.array, enemy.new(310, -3787, Turtle.scrollingSpeed, CORAL))
    table.insert(enemy.array, enemy.new(478, -3787, Turtle.scrollingSpeed, CORAL))
